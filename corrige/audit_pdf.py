...
def header(c, auditor, n, n_common, truth):
    ...
    rules = [
        ...
        "Deux actes n'existent qu'en anglais sur EUR-Lex (avis de la Banque centrale européenne) : leur titre est en anglais et leur lien est « PDF EN ». Rien d'autre ne change.",
